...
// idea: para practicar las promesas, que cada función se ejecute cuando la siguiente haya terminado, que se vaya generando el objeto .models y finalmente que se agregue directamente a game.board como promesa
// no olvides que pacman va por otro lado.
loader.load('Pacman_Blue_Ghost.glb', (gltf) => {
    const scene = gltf.scene;
    scene.traverse((child) => {
      if (child.isMesh) {
        game.board.models.blue_ghost = child;
      }
